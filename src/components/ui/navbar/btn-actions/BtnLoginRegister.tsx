...
export const BtnLoginRegister = () => {
  ...
  return (
    <button
      ...
      type="button"
      className="hidden md:inline-flex items-center justify-center bg-cerise-red-600 text-white hover:bg-cerise-red-500 font-medium rounded text-xs px-3 py-1.5 mr-2  focus:outline-none "
    >
